...
class productsSample {
    ...
    fun getProducts():List<Product>{
        ...
        productsList.add(Product("VIZIO 70-inch V-Series",751.2,"Black","p3",3,"VIZIO IQ Active 4K HDR Processor: Inside, the lightning-fast IQ Active processor delivers superior picture processing, and more intelligent 4K upscaling engine displaying your favorite HD entertainment in spectacular 4K quality.\n" +
        ...
        productsList.add(Product("Epson WF-2750",433.33,"Black","p4",4,"This printer is designed for use with Epson cartridges only, not third party cartridges or ink; Cartridges described as Compatible, Remanufactured, refilled or refillable may not work properly or at all; See product description for more details"))
